    ...
    <Card className="quote-card-view">
      <Card.Body className="p-0">
        <div className="about-para text-start">
          <p className="mb-3">
            Hi, my name is <span className="yellow">Vinay Poojary</span>, a developer based in <span className="yellow">Mumbai, India.</span>
          </p>
          <p className="mb-3">
            I am currently pursuing a <span className="yellow">Master of Science in Computer Science</span> (2024 - Present) at Mumbai University. Previously, I graduated from <span className="yellow">SIWS College, Wadala</span> with a Bachelor of Science in Computer Science in 2023.
          </p>
          <p className="mb-4">
            Outside of engineering code, here are a few things that keep me inspired:
          </p>
